...
**[View the interactive dashboard](https://anushar-214.github.io/Zomato-Data-Analysis/zomato-analysis-dashboard.html)** — a browser-based version of the analysis (`zomato-analysis-dashboard.html`), viewable without Power BI Desktop.
